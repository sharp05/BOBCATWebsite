...
export const WAYPOINTS = [
  ...
  { id: "d1", name: "Sierra Terraces Housing",          type: "dropoff", latlng: [37.3643, -120.4262] },
  { id: "d2", name: "Valley Terraces Housing",          type: "dropoff", latlng: [37.3635, -120.4250] },
  { id: "d3", name: "Half Dome Housing",                type: "dropoff", latlng: [37.3625, -120.4245] },
  { id: "d4", name: "Glacier Point Housing",            type: "dropoff", latlng: [37.3680, -120.4220] },
  { id: "d5", name: "The Summits Housing",              type: "dropoff", latlng: [37.3615, -120.4235] },
  { id: "d6", name: "Tenaya Hall",                      type: "dropoff", latlng: [37.3621, -120.4228] },
  { id: "d7", name: "Cathedral Hall",                   type: "dropoff", latlng: [37.3610, -120.4225] },
];
